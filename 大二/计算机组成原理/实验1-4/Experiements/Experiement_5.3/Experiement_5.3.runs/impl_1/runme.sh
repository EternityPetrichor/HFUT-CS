...
HD_PWD='E:/Experiements/Experiement_5.3/Experiement_5.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_4bitmux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addsub_4bitmux.tcl -notrace
