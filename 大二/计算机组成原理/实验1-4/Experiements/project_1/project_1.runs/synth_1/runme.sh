...
HD_PWD='E:/Experiements/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder4_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder4_2.tcl
