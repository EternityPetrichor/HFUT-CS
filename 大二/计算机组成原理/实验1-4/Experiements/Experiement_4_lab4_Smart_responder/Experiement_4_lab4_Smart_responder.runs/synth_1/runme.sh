...
HD_PWD='E:/Experiements/Experiement_4_lab4_Smart_responder/Experiement_4_lab4_Smart_responder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Smart_responder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Smart_responder.tcl
