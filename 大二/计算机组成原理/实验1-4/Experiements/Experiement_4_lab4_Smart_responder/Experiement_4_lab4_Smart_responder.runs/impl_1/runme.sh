...
HD_PWD='E:/Experiements/Experiement_4_lab4_Smart_responder/Experiement_4_lab4_Smart_responder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Smart_responder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Smart_responder.tcl -notrace
