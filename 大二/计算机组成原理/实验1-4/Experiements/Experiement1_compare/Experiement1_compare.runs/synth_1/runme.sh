...
HD_PWD='E:/Experiements/Experiement1_compare/Experiement1_compare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp.tcl
