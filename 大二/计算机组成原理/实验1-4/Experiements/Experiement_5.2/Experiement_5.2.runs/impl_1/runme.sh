...
HD_PWD='E:/Experiements/Experiement_5.2/Experiement_5.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addsub_4bit.tcl -notrace
