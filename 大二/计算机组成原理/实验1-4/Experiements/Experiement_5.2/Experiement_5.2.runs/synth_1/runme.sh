...
HD_PWD='E:/Experiements/Experiement_5.2/Experiement_5.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addsub_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addsub_4bit.tcl
