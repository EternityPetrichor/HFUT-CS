...
HD_PWD='E:/Experiements/Experiment_5/Experiment_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_1bit.tcl -notrace
