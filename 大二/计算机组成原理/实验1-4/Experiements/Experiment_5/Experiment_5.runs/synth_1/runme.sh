...
HD_PWD='E:/Experiements/Experiment_5/Experiment_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_1bit.tcl
